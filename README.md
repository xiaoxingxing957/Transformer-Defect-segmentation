...
P.S.Points for attention:<br>
    1.Please store your thermography data as .mat format (Matlab).<br>
    2.Please follow the procedure outlined in the introduction and use the provided codes in sequence.<br>
    3.Please use the IOU.py file to evaluate the model segmentation results. An IOU value exceeding 0.8 indicates satisfactory performance.<br>
